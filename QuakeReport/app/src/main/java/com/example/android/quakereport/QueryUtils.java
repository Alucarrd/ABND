...
public final class QueryUtils {
    ...
    private static final String LOG_TAG = "httpCall";
    ...
    /**
     * Query the USGS dataset and return a list of {@link QuakeReport} objects.
     */
     ...
     */
    public static List<QuakeReport> extractEarthquakesJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < earthquakeArray.length(); i++) {
                ...
                QuakeReport earthquake = new QuakeReport(magnitude, location, time, url);
