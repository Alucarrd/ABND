...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private URL createUrl(String stringUrl) {
            Log.v("json", stringUrl);
            URL url = null;
            try {
                url = new URL(stringUrl);
                Log.v("json", "converted");
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                    ...
                    if(responseCode == 200){
                        ...
                        Log.v("json", "My json response:" + jsonResponse);
                    }
                    else{
                        Log.e("makeHttpRequest", "error response code:" + String.valueOf(responseCode));
                    }
                ...
                Log.e("makeHttpRequest", "IO Exception");
            } finally {
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            Log.v("json", String.valueOf(earthquakeJSON.length()));
